...
import tw.edu.studentmcyang.databinding.ItemContainerReceivedMessageBinding
import tw.edu.studentmcyang.databinding.ItemContainerSendMessageBinding
...
class ChatAdapter(activity: Activity) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun getItemViewType(position: Int): Int {
        return if (differ.currentList[position].user == sharedData.getSname()) send else received
    }
}